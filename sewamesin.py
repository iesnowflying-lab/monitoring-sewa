...
try:
    ...
    st.dataframe(
        styled_df,
        column_config={
            "Jenis_Mesin": st.column_config.TextColumn("Jenis_Mesin", width=90),
            "Merek": st.column_config.TextColumn("Merek", width=70),
            "Type": st.column_config.TextColumn("Type", width=90),
            "Qty": st.column_config.NumberColumn("Qty", width=20, format="%d"),
            "From": st.column_config.TextColumn("From", width=50),
            "To": st.column_config.TextColumn("To", width=50),
            "Start_Sewa": st.column_config.DateColumn("Start_Sewa", width=70, format="DD/MM/YYYY"),
            "Akhir_Sewa": st.column_config.DateColumn("Akhir_Sewa", width=70, format="DD/MM/YYYY"),
            "Sisa": st.column_config.NumberColumn("Sisa Hari", width=20, format="%d hr"),
        },
        hide_index=True,
